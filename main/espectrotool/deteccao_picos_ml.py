...
def deteccao_picos_ml(caminho_arquivo, THRESHOLD_AMPLITUDE=50, salvar_tabela=True, arquivo_saida='resultados_picos.xslx'):
    ...
    if salvar_tabela:
        dados_tabela = []
        for r in resultados_fit:
            dados_tabela.append({'ID': r['pico_id'], 'Amplitude': r['amplitude'], 'Média (μ)': r['media'],
                                 'Erro Média': r['erro_media'], 'Desvio (σ)': r['desvio_padrao'], 'Erro Desvio': r['erro_sigma']})
...
# deteccao_picos_ml('C:/Users/z004wshk/Downloads/espectro_simulado (1).xlsx', 
#                   200, True, 'C:/Users/z004wshk/Downloads/resultados_picos.xlsx')